...
2) The raw transactional order table is core to the view_order_grain_master which drives the following views: 3.1, 3.2, 3.3, 3.4, 3.5, 4.1.0, 4.1.1, 4.1.2, 4.1.3, 4.1.3b, 4.1.4, 4.1.5, 4.2, 5.2, 5.3
